      ...
      {title && (
        <div className="card-header d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="d-flex justify-content-center align-items-center">
            <Image src={logo} roundedCircle alt="Logo" onError={(e: any) => { e.target.onerror = null; e.target.src = 'https://via.placeholder.com/150'; }} className="ml-auto mr-auto" width={150} height={150}/>
          </div>
        </div>
      )}
